...
export class AoneSDKPlatform implements Platform {
    ...
    public async playVideo(videoName: string) {
        return new Promise((resolve,reject)=>{
            egret.ExternalInterface.addCallback("sendToJS_PlayVideoResult", (msg)=> {
                console.log(msg);
                resolve();
                return;
            });

            let param = { action: "PlayVideo", video: videoName }
    ...
    public async init() {
        ...
        return new Promise((resolve,reject)=>{
            egret.ExternalInterface.addCallback("sendToJS_ReadConfigResult", (msg)=> {
                ...
                let pushToken: string = obj["pushToken"] || "";
