...
// wangshenzhuo
// 20190429
export class HXH_NewPushingGift extends Scene {

    public imgBackground: eui.Image;
    public groupMain: eui.Group;
    public imgInfoIcon: eui.Image;
    public lbCanBuy: eui.Label;
    public btnGet_2: eui.Button;
    public lbValue_2: eui.BitmapLabel;
    public scroller: eui.Scroller;
    public lstTableViewList: eui.List;
    public imgIcon: eui.Image;
    public lbSurplusTimes0: eui.Label;
    public imageIcon1: eui.Image;
    public labelValue1: eui.BitmapLabel;
    public imageLimit1: eui.Image;
    ...
    public constructor() {
        super();
        this.skinName = "resource/skins/gift/HXH_NewPushingGiftSkin.exml";
    ...
    private setInfoUpdate() {
        ...
        this.lbSurplusTimes0.textFlow = Util.RichText(str);
    }
