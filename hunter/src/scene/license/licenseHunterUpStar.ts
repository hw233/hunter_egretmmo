 ...
 * @class 领取执照界面
 */
export class licenseHunterUpStar extends Dialog {
	...
	public constructor() {
		super();
		this.skinName = "resource/skins/license/licenseHunterUpStarSkin.exml"
	...
	private setInfoLicenseInfo() {
		...
		if (Game.PlayerMissionSystem.missionActive.licence == 1) {
			...
			Helper.SetStar(this.groupStar, Game.PlayerMissionSystem.missionActive.licence, UIConfig.UIConfig_Role.heroAwakenStar[1], 1, 18);
		}
