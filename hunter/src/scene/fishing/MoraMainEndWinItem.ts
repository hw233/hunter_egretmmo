...
// 2019.05.24
export class MoraMainEndWinItem extends eui.ItemRenderer {
    ...
    public constructor() {
        super();
        this.skinName = "resource/skins/fishing/MoraMainEndWinItemSkin.exml";
        cachekeys(<string[]>UIResource["MoraMainEndWinItem"], null);
...
export class MoraMainEndWinItemData {
    father: any;
    good: any;
    index: number;
    isshow: boolean;
