namespace zj {
    ...
    // lizhengqiang
    // 20190429
    export class Activity_TimeGiftFirstPopN extends Scene {
        ...
        public constructor() {
            super();
            this.skinName = "resource/skins/activity/Activity_TimeGiftFirstPopNSkin.exml";
            ...
            this.addEventListener(egret.Event.REMOVED_FROM_STAGE, () => {
                ...
                Game.EventManager.off(GameEvent.PLAYER_GIFTS_INFO_CHANGE, this.onGiftsInfoChange, this);
        ...
        private onGiftsInfoChange(ev: PlayerGiftsInfoChangeEvent) {
            let list = ev.giftInfos;
            if (list) {
                let idx = this.info.gift_index;
