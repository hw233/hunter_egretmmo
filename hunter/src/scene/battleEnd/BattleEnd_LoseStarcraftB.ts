 ...
 * @class 跨服战斗结算失败
 */
export class BattleEnd_LoseStarcraftB extends BattleSettleLose {
	...
	public constructor() {
		super();
		this.skinName = "resource/skins/battleEnd/BattleEnd_LoseStarcraftBSkin.exml";
		this.ui_name = "BattleEnd_LoseStarcraftB";
	}
	public Init() {
		super.Init();
		this.loadSinleItem();
