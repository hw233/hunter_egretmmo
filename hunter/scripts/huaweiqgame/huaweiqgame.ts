...
export class HuaweiqgamePlugin implements plugins.Command {
    ...
    async onFile(file: plugins.File) {
        if (file.extname == '.js') {
            ...
            if (filename == 'libs/modules/egret/egret.js' || filename == 'libs/modules/egret/egret.min.js' ||
                filename == 'libs/modules/egret/egret.web.js' || filename == 'libs/modules/egret/egret.web.min.js') {
    ...
    async onFinish(pluginContext: plugins.CommandContext) {
        ...
        gameJSONContent.display.orientation = orientation;
