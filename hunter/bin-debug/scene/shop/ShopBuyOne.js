...
(function (zj) {
    ...
    //hexiaowei
    //2018/12/26
    var ShopBuyOne = (function (_super) {
        __extends(ShopBuyOne, _super);
        function ShopBuyOne() {
            var _this = _super.call(this) || this;
            _this.skinName = "resource/skins/shop/ShopBuyOneSkin.exml";
        ...
        ShopBuyOne.prototype.setInfo = function (info, father) {
            this.info = info;
            this.father = father;
        ...
        //添加龙骨动画
        ShopBuyOne.prototype.addAnimatoin = function (dbName, animationName, playTimes, group, armatureName) {
        ...
        ShopBuyOne.prototype.setInfoMall = function () {
            ...
            if (this.info.goods_id[0] == 20006) {
                own_count = zj.Game.PlayerInfoSystem.BaseInfo.psychicFruit;
            }
            else {
                own_count = zj.Game.PlayerItemSystem.itemCount(this.info.goods_id[0]);
            }
        ...
        // 物品遮罩
        ShopBuyOne.prototype.isImgMask = function (goodsId) {
        ...
        // 徽章遮罩
        ShopBuyOne.prototype.isRectMask = function (goodsId) {
        ...
        //购买
        ShopBuyOne.prototype.onBtnBuy = function () {
            /*
        ...
        ShopBuyOne.prototype.onBtnClose = function () {
            this.close(zj.UI.HIDE_TO_TOP);
        };
        return ShopBuyOne;
    }(zj.Dialog));
    zj.ShopBuyOne = ShopBuyOne;
    __reflect(ShopBuyOne.prototype, "zj.ShopBuyOne");
})(zj || (zj = {}));
//# sourceMappingURL=ShopBuyOne.js.map