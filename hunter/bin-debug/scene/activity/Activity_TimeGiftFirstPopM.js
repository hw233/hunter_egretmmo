...
var zj;
(function (zj) {
    // 惊喜包 Activity_TimeGiftFirstPopM
    // lizhengqiang
    // 20190709
    var Activity_TimeGiftFirstPopM = (function (_super) {
        __extends(Activity_TimeGiftFirstPopM, _super);
        function Activity_TimeGiftFirstPopM() {
            ...
            _this.skinName = "resource/skins/activity/Activity_TimeGiftFirstPopMSkin.exml";
        ...
        Activity_TimeGiftFirstPopM.prototype.loadPayProducts = function () {
            var _this = this;
        ...
        Activity_TimeGiftFirstPopM.prototype.setInfo = function (giftIndex, cb) {
        ...
        Activity_TimeGiftFirstPopM.prototype.setInfoTime = function () {
        ...
        Activity_TimeGiftFirstPopM.prototype.setInfoUpdate = function () {
            var giftInfo = zj.PlayerGiftSystem.Instance_item(this.info["gift_index"]);
        ...
        Activity_TimeGiftFirstPopM.prototype.setInfoItem = function () {
            var giftInfo = zj.PlayerGiftSystem.Instance_item(this.info["gift_index"]);
            this.payTbl = {};
        ...
        Activity_TimeGiftFirstPopM.prototype.refreshInfo = function (ev) {
            var _this = this;
            this.buy = true;
        ...
        Activity_TimeGiftFirstPopM.prototype.setInfoList = function () {
            var giftInfo = zj.PlayerGiftSystem.Instance_item(this.info["gift_index"]);
            var rewardList = [];
        ...
        Activity_TimeGiftFirstPopM.prototype.onBtnGet_2 = function () {
            var giftInfo = zj.PlayerGiftSystem.Instance_item(this.info["gift_index"]);
        ...
        Activity_TimeGiftFirstPopM.prototype.reqButtonBuy = function () {
            var _this = this;
        ...
        Activity_TimeGiftFirstPopM.prototype.simulateCharge = function (gameInfo, result) {
            var _this = this;
            this.btnGet_2.enabled = true;
        ...
        Activity_TimeGiftFirstPopM.prototype.synGiftInfo = function () {
            var _this = this;
            zj.Game.PlayerGiftSystem.getNewGift().then(function () {
                _this.checkGiftExit();
            });
        };
        Activity_TimeGiftFirstPopM.prototype.checkGiftExit = function () {
            var _this = this;
            zj.Game.PlayerGiftSystem.newGiftExist(this.info["index"]).then(function () {
                _this.reqButtonBuy();
            });
        };
        Activity_TimeGiftFirstPopM.prototype.onClickClose = function (e) {
        ...
        Activity_TimeGiftFirstPopM.prototype.removeShow = function () {
            var show = this.getChildByName("details");
            if (show) {
                this.removeChild(show);
            }
        };
        Activity_TimeGiftFirstPopM.prototype.showGoodsProperty = function (ev) {
            var show = zj.TipManager.ShowProp(ev.data.info, this, ev.data.xy, ev.data.cx, ev.data.cy);
            show.name = "details";
            this.addChild(show);
        };
        return Activity_TimeGiftFirstPopM;
    }(zj.Scene));
    zj.Activity_TimeGiftFirstPopM = Activity_TimeGiftFirstPopM;
    __reflect(Activity_TimeGiftFirstPopM.prototype, "zj.Activity_TimeGiftFirstPopM");
})(zj || (zj = {}));
//# sourceMappingURL=Activity_TimeGiftFirstPopM.js.map