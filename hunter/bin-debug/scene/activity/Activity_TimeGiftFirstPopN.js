...
var zj;
(function (zj) {
    // 人偶礼包 Activity_TimeGiftFirstPopN
    // lizhengqiang
    // 20190429
    var Activity_TimeGiftFirstPopN = (function (_super) {
        __extends(Activity_TimeGiftFirstPopN, _super);
        function Activity_TimeGiftFirstPopN() {
            ...
            _this.skinName = "resource/skins/activity/Activity_TimeGiftFirstPopNSkin.exml";
            ...
            zj.Game.EventManager.on(zj.GameEvent.PLAYER_GIFTS_INFO_CHANGE, _this.onGiftsInfoChange, _this);
            _this.addEventListener(egret.Event.REMOVED_FROM_STAGE, function () {
                zj.Game.EventManager.off(zj.GameEvent.SERVER_NOTICE_ROLE_INFO, _this.refreshInfo, _this);
                zj.Game.EventManager.off(zj.GameEvent.PLAYER_GIFTS_INFO_CHANGE, _this.onGiftsInfoChange, _this);
        ...
        Activity_TimeGiftFirstPopN.prototype.onGiftsInfoChange = function (ev) {
            var list = ev.giftInfos;
            if (list) {
                var idx = this.info.gift_index;
        ...
        Activity_TimeGiftFirstPopN.prototype.loadPayProducts = function () {
            var _this = this;
        ...
        Activity_TimeGiftFirstPopN.prototype.setInfo = function (giftIndex, cb) {
        ...
        Activity_TimeGiftFirstPopN.prototype.setInfoTime = function () {
        ...
        Activity_TimeGiftFirstPopN.prototype.setInfoUpdate = function () {
            var giftInfo = zj.PlayerGiftSystem.Instance_item(this.info["gift_index"]);
        ...
        Activity_TimeGiftFirstPopN.prototype.setInfoItem = function () {
            var giftInfo = zj.PlayerGiftSystem.Instance_item(this.info["gift_index"]);
            this.payTbl = {};
        ...
        Activity_TimeGiftFirstPopN.prototype.refreshInfo = function (ev) {
            var _this = this;
            this.buy = true;
        ...
        Activity_TimeGiftFirstPopN.prototype.setInfoList = function () {
            var giftInfo = zj.PlayerGiftSystem.Instance_item(this.info["gift_index"]);
            var rewardList = [];
        ...
        Activity_TimeGiftFirstPopN.prototype.onBtnGet_2 = function () {
            this.reqButtonBuy();
        };
        Activity_TimeGiftFirstPopN.prototype.reqButtonBuy = function () {
            var _this = this;
        ...
        Activity_TimeGiftFirstPopN.prototype.simulateCharge = function (gameInfo, result) {
            var _this = this;
            this.btnGet_2.enabled = true;
        ...
        Activity_TimeGiftFirstPopN.prototype.onClickClose = function (e) {
        ...
        Activity_TimeGiftFirstPopN.prototype.removeShow = function () {
            var show = this.getChildByName("details");
            if (show) {
                this.removeChild(show);
            }
        };
        Activity_TimeGiftFirstPopN.prototype.showGoodsProperty = function (ev) {
            var show = zj.TipManager.ShowProp(ev.data.info, this, ev.data.xy, ev.data.cx, ev.data.cy);
            show.name = "details";
            this.addChild(show);
        };
        return Activity_TimeGiftFirstPopN;
    }(zj.Scene));
    zj.Activity_TimeGiftFirstPopN = Activity_TimeGiftFirstPopN;
    __reflect(Activity_TimeGiftFirstPopN.prototype, "zj.Activity_TimeGiftFirstPopN");
})(zj || (zj = {}));
//# sourceMappingURL=Activity_TimeGiftFirstPopN.js.map