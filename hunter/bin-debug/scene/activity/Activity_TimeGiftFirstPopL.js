...
var zj;
(function (zj) {
    // 高级觉醒礼包 Activity_TimeGiftFirstPopL
    // lizhengqiang
    // 20190709
    var Activity_TimeGiftFirstPopL = (function (_super) {
        __extends(Activity_TimeGiftFirstPopL, _super);
        function Activity_TimeGiftFirstPopL() {
            ...
            _this.skinName = "resource/skins/activity/Activity_TimeGiftFirstPopLSkin.exml";
        ...
        Activity_TimeGiftFirstPopL.prototype.loadPayProducts = function () {
            var _this = this;
        ...
        Activity_TimeGiftFirstPopL.prototype.setInfo = function (giftIndex, cb) {
        ...
        Activity_TimeGiftFirstPopL.prototype.setInfoTime = function () {
        ...
        Activity_TimeGiftFirstPopL.prototype.setInfoUpdate = function () {
            var giftInfo = zj.PlayerGiftSystem.Instance_item(this.info["gift_index"]);
        ...
        Activity_TimeGiftFirstPopL.prototype.setInfoItem = function () {
            var giftInfo = zj.PlayerGiftSystem.Instance_item(this.info["gift_index"]);
            this.payTbl = {};
        ...
        Activity_TimeGiftFirstPopL.prototype.refreshInfo = function (ev) {
            var _this = this;
            this.buy = true;
        ...
        Activity_TimeGiftFirstPopL.prototype.setInfoList = function () {
            var giftInfo = zj.PlayerGiftSystem.Instance_item(this.info["gift_index"]);
            var rewardList = [];
        ...
        Activity_TimeGiftFirstPopL.prototype.onBtnGet_2 = function () {
            this.reqButtonBuy();
        };
        Activity_TimeGiftFirstPopL.prototype.reqButtonBuy = function () {
            var _this = this;
        ...
        Activity_TimeGiftFirstPopL.prototype.simulateCharge = function (gameInfo, result) {
            var _this = this;
            this.btnGet_2.enabled = true;
        ...
        Activity_TimeGiftFirstPopL.prototype.synGiftInfo = function () {
            var _this = this;
            zj.Game.PlayerGiftSystem.getNewGift().then(function () {
                _this.checkGiftExit();
            });
        };
        Activity_TimeGiftFirstPopL.prototype.checkGiftExit = function () {
            var _this = this;
            zj.Game.PlayerGiftSystem.newGiftExist(this.info["index"]).then(function () {
                _this.reqButtonBuy();
            });
        };
        Activity_TimeGiftFirstPopL.prototype.onClickClose = function (e) {
        ...
        Activity_TimeGiftFirstPopL.prototype.removeShow = function () {
            var show = this.getChildByName("details");
            if (show) {
                this.removeChild(show);
            }
        };
        Activity_TimeGiftFirstPopL.prototype.showGoodsProperty = function (ev) {
            var show = zj.TipManager.ShowProp(ev.data.info, this, ev.data.xy, ev.data.cx, ev.data.cy);
            show.name = "details";
            this.addChild(show);
        };
        return Activity_TimeGiftFirstPopL;
    }(zj.Scene));
    zj.Activity_TimeGiftFirstPopL = Activity_TimeGiftFirstPopL;
    __reflect(Activity_TimeGiftFirstPopL.prototype, "zj.Activity_TimeGiftFirstPopL");
})(zj || (zj = {}));
//# sourceMappingURL=Activity_TimeGiftFirstPopL.js.map