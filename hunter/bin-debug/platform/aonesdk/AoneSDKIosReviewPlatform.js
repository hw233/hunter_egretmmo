...
(function (zj) {
    // AoneSDK苹果提审包环境支持
    var AoneSDKIosReviewPlatform = (function () {
        function AoneSDKIosReviewPlatform() {
        ...
        // 当前环境是否支持该平台
        AoneSDKIosReviewPlatform.isSupport = function () {
            return (egret.Capabilities.runtimeType == egret.RuntimeType.RUNTIME2) && zj.Device.isReviewSwitch;
        };
        // 平台名字
        AoneSDKIosReviewPlatform.prototype.name = function () {
            return "aonesdk(" + this.channel + ")";
        };
        // 复制文本到剪贴板
        AoneSDKIosReviewPlatform.prototype.setClipboardData = function (str) {
            egret.ExternalInterface.call("sendToNative_setClipboardData", str);
        };
        AoneSDKIosReviewPlatform.prototype.playVideo = function (videoName) {
            return new Promise(function (resolve, reject) {
                resolve();
                return;
            });
        };
        AoneSDKIosReviewPlatform.prototype.init = function () {
        ...
        // 关闭平台
        AoneSDKIosReviewPlatform.prototype.close = function () {
            egret.ExternalInterface.call("sendToNative_close", JSON.stringify({}));
            return;
        };
        // 重启
        AoneSDKIosReviewPlatform.prototype.restart = function () {
            egret.ExternalInterface.call("sendToNative_restart", JSON.stringify({}));
            return;
        };
        // 通知平台资源加载的百分比(0~100)
        AoneSDKIosReviewPlatform.prototype.setLoadingProgress = function (percentage) {
            return;
        };
        AoneSDKIosReviewPlatform.prototype.share = function (title, imageUrl, linkUrl, query) {
            var param = {
                action: "Share",
                title: title,
                imageUrl: imageUrl,
        ...
        // 登录
        AoneSDKIosReviewPlatform.prototype.login = function (callback_success, callback_fail, callback_this) {
            var _this = this;
        ...
        AoneSDKIosReviewPlatform.prototype.do_login = function () {
            var _this = this;
        ...
        AoneSDKIosReviewPlatform.prototype.updateRole = function (type) {
        ...
        // 获取程序启动参数
        AoneSDKIosReviewPlatform.prototype.getOption = function (key) {
        ...
        AoneSDKIosReviewPlatform.prototype.getScene = function () {
            return "";
        };
        // 显示游戏圈(游戏论坛)按钮
        AoneSDKIosReviewPlatform.prototype.showClubButton = function () {
            return; // 不支持
        };
        // 隐藏游戏圈(游戏论坛)按钮
        AoneSDKIosReviewPlatform.prototype.hideClubButton = function () {
            return; // 不支持
        };
        // 短时间振动(15ms)
        AoneSDKIosReviewPlatform.prototype.vibrateShort = function () {
            return; // 不支持
        };
        // 较长时间振动(400ms)
        AoneSDKIosReviewPlatform.prototype.vibrateLong = function () {
            return; // 不支持
        };
        AoneSDKIosReviewPlatform.prototype.pay = function (productID, productNum, developerPayload) {
            if (window['AoneSDKPlatform'] && (zj.platform instanceof window['AoneSDKIosReviewPlatform'])) {
        ...
        AoneSDKIosReviewPlatform.prototype.showRewardedVideoAd = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, new Promise(function (resolve, reject) {
        ...
        AoneSDKIosReviewPlatform.prototype.showBannerAd = function () {
            return;
        };
        AoneSDKIosReviewPlatform.prototype.hideBannerAd = function () {
            return;
        };
        return AoneSDKIosReviewPlatform;
    }());
    zj.AoneSDKIosReviewPlatform = AoneSDKIosReviewPlatform;
    __reflect(AoneSDKIosReviewPlatform.prototype, "zj.AoneSDKIosReviewPlatform", ["zj.Platform"]);
    window['AoneSDKIosReviewPlatform'] = AoneSDKIosReviewPlatform;
})(zj || (zj = {}));
//# sourceMappingURL=AoneSDKIosReviewPlatform.js.map